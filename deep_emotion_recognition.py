...
class DeepEmotionRecognizer(EmotionRecognizer):
    ...
    def load_data(self):
        ...
        print('self.X_train1 ', len(self.X_train[0]))
        ...
        # print('self.y_train[0] ', len(self.y_train[0]))

        print('self.y_train ', len(self.y_train))
...
if __name__ == "__main__":
    rec = DeepEmotionRecognizer(emotions=['angry', 'sad', 'neutral', 'surprised', 'happy'],
